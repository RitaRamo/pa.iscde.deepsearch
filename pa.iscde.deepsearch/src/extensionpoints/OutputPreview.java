...
public interface OutputPreview {
	 ...
	 * 
	 */
	public void searchForScanner(String text_Search, String text_AdvancedCombo,
			ArrayList<String> buttonsSelected_AdvancedCombo, String text_SearchInCombo,
			String specificText_ComboSearchIn);
